...
module "write_storage_cluster_inventory" {
  ...
  storage_cluster_instance_ids                     = var.storage_type == "persistent" ? jsonencode(concat(var.management_node_id, local.baremetal_cluster_instance_ids, tolist(module.storage_cluster_tie_breaker_instance.instance_ids))) : jsonencode(concat(var.management_node_id,local.storage_cluster_instance_ids, tolist(module.storage_cluster_tie_breaker_instance.instance_ids, )))
  storage_cluster_instance_private_ips             = var.storage_type == "persistent" ? jsonencode(concat(var.management_node_ip, local.baremetal_cluster_instance_private_ips, tolist(module.storage_cluster_tie_breaker_instance.instance_private_ips))) : jsonencode(concat(var.management_node_ip, local.storage_cluster_instance_private_ips, tolist(module.storage_cluster_tie_breaker_instance.instance_private_ips)))
  storage_cluster_with_data_volume_mapping         = var.storage_type == "persistent" ? jsonencode(merge(var.management_node_with_vol_mapping, one(module.storage_cluster_bare_metal_server[*].instance_ips_with_vol_mapping))) : jsonencode(merge(var.management_node_with_vol_mapping, one(module.storage_cluster_instances[*].instance_ips_with_vol_mapping)))
  ...
  storage_cluster_instance_names                   = var.storage_type == "persistent" ? jsonencode(concat(var.management_node_name, local.baremetal_cluster_instance_names, keys(one(module.storage_cluster_tie_breaker_instance[*].instance_name_id_map)))) : jsonencode(concat(var.management_node_name, local.storage_cluster_instance_names, keys(one(module.storage_cluster_tie_breaker_instance[*].instance_name_id_map))))
