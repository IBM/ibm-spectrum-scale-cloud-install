...
| <a name="input_comp_sg_name"></a> [comp_sg_name](#input_comp_sg_name) | Existing compute security group name for compute nodes | `string` |
...
| <a name="input_enable_sg_validation"></a> [enable_sg_validation](#input_enable_sg_validation) | Enable or disable security group validation. Security group validation ensures that the specified security groups are properly assigned | `bool` |
...
| <a name="input_gklm_sg_name"></a> [gklm_sg_name](#input_gklm_sg_name) | Existing gklm security group name for gklm nodes | `string` |
...
| <a name="input_ldap_sg_name"></a> [ldap_sg_name](#input_ldap_sg_name) | Existing ldap security group name for ldap nodes | `string` |
...
| <a name="input_strg_sg_name"></a> [strg_sg_name](#input_strg_sg_name) | Existing storage security group name for storage nodes | `string` |
