...
2. Create terraform variable definitions file (`terraform.tfvars.json`) and provide infrastructure inputs.
    ...
    **Example 1: Storage-only Cluster**
    ...
    ```json
    {
        ...
        "vpc_storage_cluster_private_subnet_ids": ["0717-yyyyyyyy-yyyy-yyyy-yyyy-yyyyyyyyyyyy"],
    ...
    **Example 2: Compute-only Cluster**
    ...
    ```json
    {
        ...
        "vpc_compute_cluster_private_subnet_ids": ["r006-xxxx-xxxx-xxxx-xxxx"],
    ...
    **Example 3: Combined Storage and Compute Cluster**
    ...
    ```json
    {
        ...
        "resource_group_id": "default",
        "vpc_id": "r006-xxxx-xxxx-xxxx-xxxx",
        "vpc_storage_cluster_private_subnet_ids": ["r006-xxxx-xxxx-xxxx-xxxx"],
        "vpc_compute_cluster_private_subnet_ids": ["r006-xxxx-xxxx-xxxx-xxxx"],
    ...
    **Important Notes:**
    ...
    - `vpc_storage_cluster_private_subnet_ids` and `vpc_compute_cluster_private_subnet_ids` should contain **subnet IDs** (not names)
...
| <a name="input_vpc_id"></a> [vpc_id](#input_vpc_id) | ID of the VPC where resources will be deployed. | `string` |
...
| <a name="input_bastion_security_group_id"></a> [bastion_security_group_id](#input_bastion_security_group_id) | ID of the bastion security group. | `string` |
...
| <a name="input_client_security_group_id"></a> [client_security_group_id](#input_client_security_group_id) | ID of the client security group for cloud connection access (same VPC or peered VPC). | `string` |
...
| <a name="input_dns_service_instance_id"></a> [dns_service_instance_id](#input_dns_service_instance_id) | IBM Cloud DNS Service Instance name or GUID. If not provided, DNS features will be disabled. You can provide either the instance name (e.g., 'my-dns-service') or the GUID. | `string` |
...
| <a name="input_using_jumphost_connection"></a> [using_jumphost_connection](#input_using_jumphost_connection) | Enable communication from on-premise VM to VPC via bastion/jumphost. Requires `bastion_security_group_name` - the bastion security group will be added to the allowed ingress list of scale cluster security groups. | `bool` |
...
| <a name="input_vpc_compute_cluster_private_subnet_ids"></a> [vpc_compute_cluster_private_subnet_ids](#input_vpc_compute_cluster_private_subnet_ids) | List of IDs of compute cluster private subnets. | `list(string)` |
...
| <a name="input_vpc_storage_cluster_private_subnet_ids"></a> [vpc_storage_cluster_private_subnet_ids](#input_vpc_storage_cluster_private_subnet_ids) | List of IDs of storage cluster private subnets. | `list(string)` |
