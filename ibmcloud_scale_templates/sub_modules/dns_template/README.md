...
```jsonc
{
    ...
    "vpc_crn": "crn:v1:bluemix:public:is:us-south:a/1234567890abcdef::vpc:r006-xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",
...
```jsonc
{
    ...
    "resource_prefix": "scale-dns",
    "resource_group_id": "aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee",
    "vpc_crn": "crn:v1:bluemix:public:is:us-east:a/1234567890abcdef::vpc:r006-xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",
    "cluster_type": "Combined-compute-storage",
    "vpc_storage_cluster_dns_domain": "storage.scale.local",
    "vpc_compute_cluster_dns_domain": "compute.scale.local",
    "create_dns_zone": true
...
| <a name="input_resource_group_id"></a> [resource_group_id](#input_resource_group_id) | ID of the IBM Cloud resource group where DNS service instance will be created. | `string` |
...
| <a name="input_vpc_crn"></a> [vpc_crn](#input_vpc_crn) | VPC CRN to be associated with the DNS zone. | `string` |
...
| <a name="input_dns_service_instance_id"></a> [dns_service_instance_id](#input_dns_service_instance_id) | IBM Cloud DNS Service Instance GUID. If not provided, a new DNS service instance will be created. You must provide the GUID (e.g., 'aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee'), not the instance name. | `string` |
...
| <a name="output_vpc_protocol_dns_domain"></a> [vpc_protocol_dns_domain](#output_vpc_protocol_dns_domain) | IBM Cloud DNS protocol cluster domain name. |
