...
2. Create terraform variable definitions file (`terraform.tfvars.json`) and provide infrastructure inputs.
    ...
    | Note: In case of multi availability zone, provide 3 AZ values for the `vpc_availability_zone` keyword. Ex: `"vpc_availability_zones"=["us-south-1", "us-south-2", "us-south-3"]` |
    | --- |
