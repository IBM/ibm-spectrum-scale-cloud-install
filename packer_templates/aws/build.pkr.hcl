build {
  ...
  provisioner "shell" {
    inline = [
      ...
      "sudo sh -c \"echo 'name=IBM Storage Scale Zimon Repository Rhel8' >> /etc/yum.repos.d/scale.repo\"",
      ...
      "sudo sh -c \"echo 'gpgcheck=1' >> /etc/yum.repos.d/scale.repo\"",
      "sudo sh -c \"echo 'gpgkey=http://\"${var.package_repository}\".s3-website.\"${var.vpc_region}\".amazonaws.com/\"${var.scale_version}\"/Public_Keys/Storage_Scale_public_key.pgp\n' >> /etc/yum.repos.d/scale.repo\"",
      "sudo sh -c \"echo '[NFSProtocolRepositoryRhel8]' >> /etc/yum.repos.d/scale.repo\"",
      "sudo sh -c \"echo 'name=IBM Storage Scale NFS Protocol Repository Rhel8' >> /etc/yum.repos.d/scale.repo\"",
      "sudo sh -c \"echo 'baseurl=http://\"${var.package_repository}\".s3-website.\"${var.vpc_region}\".amazonaws.com/\"${var.scale_version}\"/ganesha_rpms/rhel8/' >> /etc/yum.repos.d/scale.repo\"",
      "sudo sh -c \"echo 'enabled=1' >> /etc/yum.repos.d/scale.repo\"",
      "sudo sh -c \"echo 'gpgcheck=1' >> /etc/yum.repos.d/scale.repo\"",
      "sudo sh -c \"echo 'gpgkey=http://\"${var.package_repository}\".s3-website.\"${var.vpc_region}\".amazonaws.com/\"${var.scale_version}\"/Public_Keys/Storage_Scale_public_key.pgp\n' >> /etc/yum.repos.d/scale.repo\"",
      "sudo sh -c \"echo '[SMBProtocolRepositoryRhel8]' >> /etc/yum.repos.d/scale.repo\"",
      "sudo sh -c \"echo 'name=IBM Storage Scale SMB Protocol Repository Rhel8' >> /etc/yum.repos.d/scale.repo\"",
      "sudo sh -c \"echo 'baseurl=http://\"${var.package_repository}\".s3-website.\"${var.vpc_region}\".amazonaws.com/\"${var.scale_version}\"/smb_rpms/rhel8/' >> /etc/yum.repos.d/scale.repo\"",
      "sudo sh -c \"echo 'enabled=1' >> /etc/yum.repos.d/scale.repo\"",
      "sudo sh -c \"echo 'gpgcheck=1' >> /etc/yum.repos.d/scale.repo\"",
      "sudo sh -c \"echo 'gpgkey=http://\"${var.package_repository}\".s3-website.\"${var.vpc_region}\".amazonaws.com/\"${var.scale_version}\"/Public_Keys/Storage_Scale_public_key.pgp\n' >> /etc/yum.repos.d/scale.repo\"",
      ...
      "sudo sh -c \"echo 'name=IBM Storage Scale Zimon Repository Rhel9' >> /etc/yum.repos.d/scale.repo\"",
      ...
      "sudo sh -c \"echo '[NFSProtocolRepositoryRhel9]' >> /etc/yum.repos.d/scale.repo\"",
      "sudo sh -c \"echo 'name=IBM Storage Scale NFS Protocol Repository Rhel9' >> /etc/yum.repos.d/scale.repo\"",
      "sudo sh -c \"echo 'baseurl=http://\"${var.package_repository}\".s3-website.\"${var.vpc_region}\".amazonaws.com/\"${var.scale_version}\"/ganesha_rpms/rhel9/' >> /etc/yum.repos.d/scale.repo\"",
      "sudo sh -c \"echo 'enabled=1' >> /etc/yum.repos.d/scale.repo\"",
      "sudo sh -c \"echo 'gpgcheck=1' >> /etc/yum.repos.d/scale.repo\"",
      "sudo sh -c \"echo 'gpgkey=http://\"${var.package_repository}\".s3-website.\"${var.vpc_region}\".amazonaws.com/\"${var.scale_version}\"/Public_Keys/Storage_Scale_public_key.pgp' >> /etc/yum.repos.d/scale.repo\"",
      "sudo sh -c \"echo '[SMBProtocolRepositoryRhel9]' >> /etc/yum.repos.d/scale.repo\"",
      "sudo sh -c \"echo 'name=IBM Storage Scale SMB Protocol Repository Rhel9' >> /etc/yum.repos.d/scale.repo\"",
      "sudo sh -c \"echo 'baseurl=http://\"${var.package_repository}\".s3-website.\"${var.vpc_region}\".amazonaws.com/\"${var.scale_version}\"/smb_rpms/rhel9/' >> /etc/yum.repos.d/scale.repo\"",
      "sudo sh -c \"echo 'enabled=1' >> /etc/yum.repos.d/scale.repo\"",
      "sudo sh -c \"echo 'gpgcheck=1' >> /etc/yum.repos.d/scale.repo\"",
      "sudo sh -c \"echo 'gpgkey=http://\"${var.package_repository}\".s3-website.\"${var.vpc_region}\".amazonaws.com/\"${var.scale_version}\"/Public_Keys/Storage_Scale_public_key.pgp' >> /etc/yum.repos.d/scale.repo\"",
      "fi",
