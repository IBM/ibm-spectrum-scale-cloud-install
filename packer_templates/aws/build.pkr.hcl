build {
  ...
  provisioner "shell" {
    inline = [
      ...
      "sudo pip3 install awscli requests",
      ...
      "fi",
      "sudo dnf install -y gpfs.base gpfs.docs gpfs.msg.en* gpfs.compression gpfs.ext gpfs.gpl gpfs.gskit gpfs.gui gpfs.java gpfs.gss.pmcollector gpfs.gss.pmsensors gpfs.afm.cos gpfs.adv gpfs.compression gpfs.crypto",
