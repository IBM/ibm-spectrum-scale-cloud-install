    ...
    ```jsonc
        {
            ...
            "bastion_public_subnet_ids": [
                "/subscriptions/xxx3cd6f-667b-4a89-a046-dexxxxxxxx/resourceGroups/spectrum-scaleprvn-rg/providers/Microsoft.Network/virtualNetworks/spectrum-scaleprvn-vpc/subnets/AzureBastionSubnet-0"
            ],
...
| <a name="input_vpc_location"></a> [vpc_location](#input_vpc_location) | The location/region of the vnet to create. Examples are East US, West US, etc. | `string` |
