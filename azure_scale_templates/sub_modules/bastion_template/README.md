...
2. Create terraform variable definitions file (`terraform.tfvars.json`) and provide infrastructure inputs.
    ...
    ```jsonc
    {
        ...
        "vnet_public_subnet_id": "/subscriptions/xyz/resourceGroups/spectrum-scale-rg/providers/Microsoft.Network/virtualNetworks/spectrum-scale-vnet/subnets/AzureBastionSubnet"
    }
    ```
