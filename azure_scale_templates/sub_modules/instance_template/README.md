...
2. Create terraform variable definitions file (`terraform.tfvars.json`) and provide infrastructure inputs.
    ...
    ```jsonc
    {
        ...
        "vpc_storage_cluster_private_subnets": [
            "/subscriptions/xyz/resourceGroups/spectrum-scale-rg/providers/Microsoft.Network/virtualNetworks/spectrum-scale-vpc/subnets/spectrum-scale-strg-priv-snet-0"
        ],
        ...
        "ansible_jump_host_id": "/subscriptions/xyz/resourceGroups/spectrum-scale-rg/providers/Microsoft.Compute/virtualMachines/scale-bastion-0",
        ...
        "storage_cluster_image_ref": "/subscriptions/xyz/resourceGroups/spectrum-scale-rg/providers/Microsoft.Compute/images/scale-image-52b8dae6836b0519"
    }
    ```
    ...
    ```jsonc
    {
        ...
        "vpc_compute_cluster_private_subnets": [
            "/subscriptions/xyz/resourceGroups/spectrum-scale-rg/providers/Microsoft.Network/virtualNetworks/spectrum-scale-vpc/subnets/spectrum-scale-comp-priv-snet-0"
        ],
        "resource_group_name": "spectrum-scale-rg",
        ...
        "using_jumphost_connection": true,
        "vm_size": "Standard_A2_v2",
        "compute_cluster_image_ref": "/subscriptions/xyz/resourceGroups/spectrum-scale-rg/providers/Microsoft.Compute/images/scale-image-52b8dae6836b0519"
    }
    ```
...
| <a name="input_total_gateway_instances"></a> [total_gateway_instances](#input_total_gateway_instances) | Number of Azure instances (vms) to be launched for gateway nodes. | `number` |
| <a name="input_total_protocol_instances"></a> [total_protocol_instances](#input_total_protocol_instances) | Number of Azure instances (vms) to be launched for protocol nodes. | `number` |
...
| <a name="output_protocol_cluster_security_group_id"></a> [protocol_cluster_security_group_id](#output_protocol_cluster_security_group_id) | Protocol cluster security group ids. |
