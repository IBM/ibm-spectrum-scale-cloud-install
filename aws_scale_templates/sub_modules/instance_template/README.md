...
| <a name="input_enable_nitro_block_device"></a> [enable_nitro_block_device](#input_enable_nitro_block_device) | Enable NVMe block devices (built on Nitro instances). | `bool` |
