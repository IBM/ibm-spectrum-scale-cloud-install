...
| <a name="input_is_gpu_enabled"></a> [is_gpu_enabled](#input_is_gpu_enabled) | Flag to represent whether to create GPU scale cluster | `bool` |
...
| <a name="output_ces_private_ips"></a> [ces_private_ips](#output_ces_private_ips) | CES/Protocol routing ips |
