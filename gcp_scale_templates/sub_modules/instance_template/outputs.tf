...
output "storage_cluster_security_id" {
  value       = (local.cluster_type == "storage" || local.cluster_type == "combined") ? concat(module.allow_traffic_scale_cluster_storage_ingress.firewall_uri_ingress, module.allow_traffic_scale_cluster_storage_egress_all.firewall_uri_egress, module.allow_traffic_scale_cluster_storage_egress_all.firewall_uri_egress_all) : null
  description = "Storage cluster security ids."
}

output "compute_cluster_security_id" {
  value       = (local.cluster_type == "compute" || local.cluster_type == "combined") ? module.allow_traffic_scale_cluster_compute_ingress.firewall_uri_ingress : null
