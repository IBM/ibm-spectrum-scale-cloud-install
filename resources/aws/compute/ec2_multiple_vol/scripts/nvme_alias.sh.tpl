...
#nvme_device_list=( $(find /dev | grep -i 'nvme[0-25]n1$') )
readarray -t nvme_device_list  < <(find /dev | grep -i 'nvme[0-25]n1$')

log "Discovered device: $${nvme_device_list[*]}"
...
do
   ...
   device_mount_list=$(echo $lsblk_out | jq ".blockdevices[].children[].mountpoints[]")
