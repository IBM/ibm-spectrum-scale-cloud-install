...
auth_token1=$(curl -k -X POST -H "Content-Type: application/json" -H "Accept: application/json" -d '{"userid":"SKLMAdmin","password":"SKLM@dmin123"}' https://localhost:9443/SKLM/rest/v1/ckms/login)
